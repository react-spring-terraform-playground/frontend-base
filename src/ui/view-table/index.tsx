...
import { MxCheckBox } from "../checkbox-field";
import { MxMultiCheckBox } from "../multi-checkbox";
import { MxInputNumber } from "../number-field";
import { MxInputPassword } from "../password-field";
import { MxRadioBox } from "../radio-box";
import { MxSelectNumberBox, MxSelectBox } from "../select-box";
import { MxTextArea } from "../text-area";
import { MxProps, MxInputText } from "../text-field";
...
export const MxTableLayout = (props: MxTableLayoutProps) => {
  ...
  const rowLimit = Math.floor(
    items.length / props.colSize + (items.length % props.colSize === 0 ? 0 : 1)
  );
...
export const selectComponent = (
  ...
  if (item instanceof CsInputTextItem) {
    const props: MxProps<CsInputTextItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsInputNumberItem) {
    const props: MxProps<CsInputNumberItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsTextAreaItem) {
    const props: MxProps<CsTextAreaItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsCheckBoxItem) {
    const props: MxProps<CsCheckBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsInputPasswordItem) {
    const props: MxProps<CsInputPasswordItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsRadioBoxItem) {
    const props: MxProps<CsRadioBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsSelectNumberBoxItem) {
    const props: MxProps<CsSelectNumberBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsSelectBoxItem) {
    const props: MxProps<CsSelectBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
  ...
  if (item instanceof CsMultiCheckBoxItem) {
    const props: MxProps<CsMultiCheckBoxItem> = {
      item,
      hideLabel,
      labelPlacement,
      labelWidth,
